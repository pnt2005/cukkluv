        ...
        <div className="row align-items-center gy-5">
          ...
          <div className="col-lg-6 text-center">
            <div className="image-container">
              <img src={com} alt="Com" className="image" />
            </div>
          </div>
        </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 mb-4 mb-lg-0">
              ...
              <p className="text-muted">
                Tại <span className="text-warning fw-bold">CukkLuv</span>, chúng
                tôi tin rằng ẩm thực là cầu nối tuyệt vời nhất. Sứ mệnh cốt lõi
                của chúng tôi là khơi nguồn cảm hứng và kết nối cộng đồng yêu
                bếp từ khắp mọi miền. Chúng tôi tạo ra một không gian số sôi
                nổi, nơi mọi người, từ đầu bếp chuyên nghiệp đến người mới bắt
                đầu, đều có thể tìm thấy niềm vui và sự ủng hộ trong hành trình
                ẩm thực của mình.
              </p>
              <p className="text-muted">
                <span className="text-warning fw-bold">CukkLuv</span> cam kết
                trở thành kho tàng lưu giữ và phát huy tinh hoa ẩm thực. Chúng
                tôi mong muốn mang những công thức truyền thống, những món ăn
                gia đình ấm cúng của Việt Nam, cùng với các sáng tạo ẩm thực
                hiện đại, đến gần hơn với mọi nhà. Mục tiêu là để mỗi bữa ăn
                không chỉ là việc lấp đầy dạ dày mà còn là cách để tôn vinh và
                tiếp nối văn hóa bếp Việt.
              </p>
            </div>
